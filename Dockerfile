...
ENV UUID 30207485-dd85-45b6-a9d5-4e5acd7c18b3
...
RUN wget -q -O /tmp/v2ray-linux-64.zip https://github.com/v2fly/v2ray-core/releases/download/v5.23.0/v2ray-linux-64.zip && \
